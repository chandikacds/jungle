...
$variations_options 	= (array) WC_Vendors::$pv_options->get_option( 'hide_product_variations' );
?>
...
<div class="wcv_variation wcv-metabox closed all-100" rel="<?php echo esc_attr( $variation_id ); ?>" data-loop="<?php echo $loop; ?>">
	...
	<div class="wcv_variable_attributes wcv-metabox-content" style="display: none;">
			...
			<div class="wcv-cols-group wcv-horizontal-gutters">
				...
				<?php if ( ! $variations_options['featured'] ) : ?>
			...
			<div class="wcv-cols-group wcv-horizontal-gutters">
				<div class="all-100"> 		
					...
					<div class="wcv-column-group">
				        <div class="all-25">
				        	<?php if (! $variations_options[ 'enabled' ] ) : ?>
				        ...
				        <div class="all-25" hidden>
					        <?php if (! $variations_options[ 'downloadable' ] ) : ?>
				        ...
				        <div class="all-25">
					        <?php if (! $variations_options[ 'virtual' ] ) : ?>
							...
							<label><?php _e( 'Service', 'wcvendors-pro' ); ?></label>
							<?php endif; ?>
				        </div>
				        <?php if (! $variations_options[ 'manage_stock' ] ) : ?>
				        <?php if ( get_option( 'woocommerce_manage_stock' ) == 'yes' ) : ?>
				    	<div class="all-25" hidden>
				        	<input  class="checkbox variable_manage_stock" name="variable_manage_stock[<?php echo $loop; ?>]" <?php checked( isset( $_manage_stock ) ? $_manage_stock : '', 'yes' ); ?> />
			...
			<div class="wcv-cols-group wcv-horizontal-gutters variable_pricing">
				...
				<div class="all-50">
				<?php if (! $variations_options[ 'sale_price' ] ) : ?>
					<div class="control-group">
			...
			<div class="wcv-cols-group wcv-horizontal-gutters show_if_variation_manage_stock" style="display: none;">
				...
				<div class="all-50">
				<?php if (! $variations_options[ 'allow_backorders' ] ) : ?>
					<div class="control-group">
			...
			<?php if ( wc_product_weight_enabled() || wc_product_dimensions_enabled() ) : ?>
				<div class="wcv-cols-group wcv-horizontal-gutters">
				<?php if (! $variations_options[ 'weight' ] ) : ?>
					...
					<?php if (! $variations_options[ 'dimensions' ] ) : ?>
			...
			<div class="wcv-cols-group wcv-horizontal-gutters hide_if_variation_virtual">
				<div class="all-100"> 
				<?php if (! $variations_options[ 'shipping_class' ] ) : ?>
					<div class="control-group"> 
			...
			<div class="wcv-cols-group wcv-horizontal-gutters">
				<div class="all-100"> 
					<?php if (! $variations_options[ 'tax_class' ] ) : ?>
					<div class="control-group"> 
			...
			<div class="wcv-cols-group wcv-horizontal-gutters">
				<div class="all-100"> 
				<?php if (! $variations_options[ 'description' ] ) : ?>
					<div class="control-group"> 
			...
			<div class="wcv-cols-group wcv-horizontal-gutters show_if_variation_downloadable" style="display: none;">
				<div class="all-100"> 
				<?php if (! $variations_options[ 'download_files' ] ) : ?>
			...
			<div class="wcv-cols-group wcv-horizontal-gutters show_if_variation_downloadable" style="display: none;">
				<?php if (! $variations_options[ 'download_files' ] ) : ?>
				<div class="all-50"> 
					<?php if (! $variations_options[ 'download_limit' ] ) : ?>
					<div class="control-group"> 
				...
				<div class="all-50"> 
					<?php if (! $variations_options[ 'download_expiry' ] ) : ?>
					<div class="control-group"> 
