...
function get_table_columns()
{
	$columns = array(
			...
			'message' => __('Message', 'front-end-pm'),
			'datetime' => __('Date/Time', 'front-end-pm')
			);
...
function get_column_content($column)
{
	switch( $column ) {
		...
		case 'author' :
			?>
			<div class="fep-message-author"><?php echo fep_user_name( get_the_author_meta('ID') ); ?></div>
			<!-- <span class="fep-message-author"><?php echo fep_user_name( get_the_author_meta('ID') ); ?></span> -->
			<!-- <span class="fep-message-date"><?php the_time(); ?></span> -->
			<?php
		break;
		case 'title' :
			if( ! fep_is_read( true ) ) {
		 	...
		 	<div class="fep-message-excerpt"><a href="<?php echo fep_query_url('viewmessage', array('fep_id'=> get_the_ID())); ?>"><?php the_title(); ?></a></div>
		 	<?php echo $span; ?>
		 	<!-- <div class="fep-message-excerpt"><?php echo fep_get_the_excerpt(100); ?></div> -->
		<?php
		break;
		case 'message' :
		...
		break;
		case 'datetime' :
		 	?><div class="fep-message-date"><?php the_time(); ?></div><?php
		break;
		default:
