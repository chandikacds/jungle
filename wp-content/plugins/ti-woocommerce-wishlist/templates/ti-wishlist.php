...
<div class="tinv-wishlist woocommerce tinv-wishlist-clear">
	...
	<form action="<?php echo esc_url( tinv_url_wishlist() ); ?>" method="post" autocomplete="off">
		...
		<table class="tinvwl-table-manage-list ViewWishlist">
			<thead>
			<tr>
				...
				<th class="product-name">
					<!-- span class="tinvwl-full"><?php esc_html_e( 'Product Name', 'ti-woocommerce-wishlist' ); ?></span>
					<span class="tinvwl-mobile"><?php esc_html_e( 'Product', 'ti-woocommerce-wishlist' ); ?></span -->
				</th>
					...
					<tr class="<?php echo esc_attr( apply_filters( 'tinvwl_wishlist_item_class', 'wishlist_item', $wl_product, $product ) ); ?>">
						...
						<?php if ( isset( $wishlist_table_row['colm_stock'] ) && $wishlist_table_row['colm_stock'] ) { ?>
							<td class="product-stock">
								...
								<span class="tinvwl-txt">' . esc_html__( 'In stock', 'ti-woocommerce-wishlist' ) . '</span></p>' : 
								'<p class="stock ' . esc_attr( $availability['class'] ) . '">
							...
							<td class="product-action">
								...
								if ( apply_filters( 'tinvwl_wishlist_item_action_add_to_cart', $wishlist_table_row['add_to_cart'], $wl_product, $product ) ) {
									...
									<button class="button alt" name="tinvwl-add-to-cart"
											...
											<span class="tinvwl-txt"><?php echo esc_html( apply_filters( 'tinvwl_wishlist_item_add_to_cart', $wishlist_table_row['text_add_to_cart'], $wl_product, $product ) ); ?>
										    </span>
									</button>
								<?php } ?>
							</td>
