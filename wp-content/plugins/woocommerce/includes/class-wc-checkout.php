			...
			foreach ( $fieldset as $key => $field ) {
				...
				if ( $required && '' === $data[ $key ] ) {
					...
					if ( is_user_logged_in() ) {
						...
						$errors->add( 'required-field', apply_filters( 'woocommerce_checkout_required_field_notice', sprintf( __( '%s is a required field.'.$key, 'woocommerce' ), '<strong>' . esc_html( $field_label ) . '</strong>' ), $field_label ) );
					}
